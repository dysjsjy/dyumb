...
import com.dy.umb.mapper.TeamMapper;
...
import com.dy.umb.model.enums.TeamStatusEnum;
...
import com.dy.umb.model.vo.UserVO;
...
public class TeamServiceImpl extends ServiceImpl<TeamMapper, Team>
    ...
    public boolean joinTeam(TeamJoinRequest teamJoinRequest, User loginUser) {
        ...
        // 只有一个线程能获取到锁
        RLock lock = redissonClient.getLock("dy:join_team");
        try {
            // 抢到锁并执行
            while (true) {
